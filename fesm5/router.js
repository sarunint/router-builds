...
import { BehaviorSubject, EMPTY, EmptyError, Observable, Subject, combineLatest, defer, from, of } from 'rxjs';
import { catchError, concatAll, concatMap, every, filter, finalize, first, last, map, mergeAll, mergeMap, reduce, scan, startWith, switchMap, take, tap } from 'rxjs/operators';
...
function recognize$$1(rootComponentType, config, serializer, paramsInheritanceStrategy, relativeLinkResolution) {
    return function (source) {
        return source.pipe(mergeMap(function (t) { return recognize$1(rootComponentType, config, t.urlAfterRedirects, serializer(t.urlAfterRedirects), paramsInheritanceStrategy, relativeLinkResolution)
